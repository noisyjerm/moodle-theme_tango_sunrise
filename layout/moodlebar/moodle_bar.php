...
// My Moodle icon 
echo '<a class="tooltip" href="'.$CFG->wwwroot.'/my/" /><img src="' . $OUTPUT->pix_url('mb/user', 'theme') . '" title="MyMoodle"  /><span>MyMoodle Page</span></a>';
...
echo '<a class="tooltip" href="'.$CFG->wwwroot.'/blog/" /><img src="' . $OUTPUT->pix_url('mb/blog', 'theme') . '" title="Blogs"  /><span>Blogs</span></a>';
echo '<a class="tooltip" href="'.$CFG->wwwroot.'/blog/edit.php?action=add" /><img src="' . $OUTPUT->pix_url('mb/blogadd', 'theme') . '" title="Add a blog entry"  /><span>Add a blog entry</span></a>';
}
